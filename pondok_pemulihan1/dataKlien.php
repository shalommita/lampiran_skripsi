...
<head>
    ...
    <style>
        ...
        .btn-edit {
            background-color: orange; /* Green color for the edit button */
...
<body>
                            ...
                            if ($searchResult->num_rows > 0) {
                                while ($row = $searchResult->fetch_assoc()) {
                                    ...
                                    if (isset($row["idKlien"])) {
                                        echo "<a href='editKlien.php?id=" . $row["idKlien"] . "' class='btn btn-edit'><i class='bi bi-pencil'></i></a>";
                                        echo "&nbsp;"; // Add some space between buttons
                                        echo "<button class='btn btn-edit' onclick='printIndividual(\"" . $row["idKlien"] . "\")'>Cetak</button>";
                                    }
                                    echo "</td>";
    ...
    <script>
        ...
        function printIndividual(clientId) {
            // You can customize this URL based on your actual file structure
            var printUrl = "printIndividual.php?klien=" + clientId;
