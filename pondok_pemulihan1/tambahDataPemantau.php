                                    ...
                                    <div class="form-group row mb-3 align-items-center">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control" name="peran" required>
                                                ...
                                                <option value="Psikolog Klinis" <?php if ($peranPemantau == 'Psikolog Klinis') echo 'selected'; ?>>Psikolog Klinis</option>
                                                <option value="Psikososial" <?php if ($peranPemantau == 'Psikososial') echo 'selected'; ?>>Psikososial</option>
                                                <option value="AsistenMedis" <?php if ($peranPemantau == 'AsistenMedis') echo 'selected'; ?>>Asisten Medis</option>
